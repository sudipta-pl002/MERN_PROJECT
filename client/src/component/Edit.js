...
const Edit = () => {
    ...
    const updateuser =async(e) =>{
         e.preventDefault();
            ...
            const { name, email, age, work, mobile, add, desc} = inpval;
         const res2 = await fetch(`https://mernproj01.herokuapp.com/updateuser/${id}`,{
            method: "PATCH",
            headers: {
                "Content-Type": "application/json"
            },
            body :JSON.stringify({
                name, email, age, work, mobile, add, desc
            })
         });
            ...
            <form className="mt-4">
                <div className="row">
                    ...
                    <div class="mb-3 col-lg-12 col-md-12 col-12">
                        <label for="exampleInputPassword1" class="form-label">DESCRIPRION</label>
